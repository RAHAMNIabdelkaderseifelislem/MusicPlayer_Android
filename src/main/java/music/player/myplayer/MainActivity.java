...
import music.player.myplayer.adapters.AlbumsAdapter;
import music.player.myplayer.adapters.ArtistsAdapter;
import music.player.myplayer.adapters.ColorsAdapter;
import music.player.myplayer.adapters.SongsAdapter;
import music.player.myplayer.loaders.ArtistProvider;
import music.player.myplayer.models.Album;
import music.player.myplayer.models.Artist;
import music.player.myplayer.models.Song;
import music.player.myplayer.playback.EqualizerUtils;
import music.player.myplayer.playback.MusicNotificationManager;
import music.player.myplayer.playback.MusicService;
import music.player.myplayer.playback.PlaybackInfoListener;
import music.player.myplayer.playback.PlayerAdapter;
import music.player.myplayer.slidinguppanel.SlidingUpPanelLayout;
...
public class MainActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<List<Artist>>, SongsAdapter.SongSelectedListener, ColorsAdapter.AccentChangedListener, AlbumsAdapter.AlbumSelectedListener, ArtistsAdapter.ArtistSelectedListener {
    ...
    public void openGitPage(View v) {
        try {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/RAHAMNIabdelkaderseifelislem")));
