...
public class Utils {
    ...
    private static final String ACCENT_PREF = "music.player.myplayer.pref_accent";
    private static final String ACCENT_VALUE = "music.player.myplayer.pref_accent_value";
    private static final String THEME_PREF = "music.player.myplayer.pref_theme";
    private static final String THEME_VALUE = "music.player.myplayer.pref_theme_value";
